...
ok(entrySrc.includes("MIN_SUBDIVISION_CONFIDENCE = confidenceFloor('MAXMIND_MIN_SUBDIVISION_CONFIDENCE', 51)"), 'real-money gate requires a minimum MaxMind subdivision confidence');
