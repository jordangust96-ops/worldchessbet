...
assert.match(copy({wallet:{held_balance:10},funding:verified}).message,/Identity verified and bank connected/);
assert.match(copy({funding:{...verified,recent:[{type:"deposit",status:"completed",deposit_hold_status:"held"}]}}).message,/verified for play/);
