...
export default function MatchCenter({ userId, balance }) {
  return (
    <div className="rounded-3xl bg-gradient-to-br from-[#1A1A1A] to-[#111] border border-white/5 p-6 lg:p-5 lg:h-full lg:overflow-hidden lg:flex lg:flex-col lg:justify-center">
      <AvailableMatchSection userId={userId} />
      <div className="h-px bg-white/[0.06] my-6 lg:my-4" />
