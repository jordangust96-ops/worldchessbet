      ...
      {(noFunds || launchClosed) && !disabled && (
        <div className="rounded-xl bg-[#C9A84C]/10 border border-[#C9A84C]/20 p-3 flex items-center gap-2.5">
          ...
          <p className="text-xs text-[#C9A84C]/80 leading-snug">
            {launchClosed ? "Paid contests are currently unavailable." : noFunds ? "Fund your wallet to accept or create a challenge." : availability?.deposits_enabled ? "Add funds to create a challenge." : "Deposits are currently unavailable."}{" "}
