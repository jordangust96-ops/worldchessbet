...
- Signup: legal first/last name, email/password or social provider; email OTP, policy acceptance, MFA. These account requirements remain. No location, identity-document, bank or deposit step is required for free play.
